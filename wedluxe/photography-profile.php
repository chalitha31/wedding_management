        ...
        <div class="photographer-profile-container">
            ...
            <div class="package-page">
                ...
                <div class="package-container">
                    ...
                    ?>
                        ...
                        <div class="package photo-pack" onclick="phPackageDetails(<?php echo $pac['id'] ?>);">
                            ...
                            <ul>
                                ...
                                $resultset = Database::search("SELECT * FROM `photography_package_features` WHERE `package_id` = '" . $pac["id"] . "'  LIMIT 4 ");
                ...
                <div class="photos-container">
                    ...
                    ?>
                        ...
                        <div class="photo-block">
                            <img class="photo clk" src="images/photographers/photography-gallery/<?php echo $rowData["image"] ?>" alt="">
            ...
            <div class="review-page">
                ...
                <div class="box-container">
                    ...
                    $result = Database::search("SELECT * FROM `feedback` WHERE `booking_table_id` = '2' AND `bok_id` = '" . $phot_id . "' AND `status` = '0'");
