        ...
        <div class="hotel-profile-container">
            ...
            <div class="profile-background-image">
                ...
                <div class="hotel-major-content">
                    ...
                    <div class="hotel-description">
                        ...
                        <h4>location : <a style="color: lightblue; " href <?php echo $hotelData["location"] ?>>Go to Google Maps</a></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="package-page">
                ...
                <div class="package-container">
                    ...
                    ?>
                        ...
                        <div class="package hotel-packages" onclick="packageDetails(<?php echo $pac['id'] ?>);">
                            ...
                            <ul>
                                ...
                                $resultset = Database::search("SELECT * FROM `package_features` WHERE `package_id` = '" . $pac["id"] . "'  LIMIT 4 ");
                ...
                <div class="photos-container">
                    ...
                    ?>
                        ...
                        <div class="photo-block">
                            <img class="photo clk" src="images/hotels/hotel-gallery/<?php echo $rowData["image"] ?>" alt="">
            ...
            <div class="review-page">
                ...
                <div class="box-container">
                    ...
                    $result = Database::search("SELECT * FROM `feedback` WHERE `booking_table_id` = '0' AND `bok_id` = '" . $Hotelid . "' AND `status` = '0'");
                    ...
                    ?>
                            ...
                            <div class="box" id="removefeedback<?php echo $feedData["id"] ?>">
                                ...
                                <!-- <div style="width: 100%; position: absolute; left: -10px; text-align: end;" class="">X</div> -->
                                <?php
