...
?>
    ...
    <body onload="djDate('<?php echo $packageid ?>');">
        <!-- <header>
        ...
        <div class="package-view-page">
            ...
            <?php
            $pakage = Database::search("SELECT * FROM `dj_package` WHERE `id` = '" . $packageid . "' ");
            $n = $pakage->num_rows;
            ...
            <div class="package-area">
                <div class="package-container">
                    <div class="package-img-holder">
                        <img src="images/dj/package_img/<?php echo $pacData["preview_image"] ?>" alt="" class="package-img">
                    </div>
                    <div class="package-description">
                        ...
                        <ul class="package-features-box">
                            ...
                            $resultset = Database::search("SELECT * FROM `dj_package_features` WHERE `package_id` = '" . $packageid . "'  ");
            ...
            <div class="booking-area">
                <div class="booking-container">
                    ...
                    ?>
                        ...
                        $Hresult = Database::search("SELECT * FROM `dj_booking` WHERE `user_email` = '" . $_SESSION["user_email"] . "' AND `order_status` = 'confirmed' AND `pay_id` = '2' ORDER BY `id` DESC LIMIT 1");
                        $nrow = $Hresult->num_rows;
                        if ($nrow == "1") {
                            $data = $Hresult->fetch_assoc();
                            $Prepakage = Database::search("SELECT * FROM `dj_package` WHERE `id` = '" . $data["packag_id"] . "'");
                        ...
                        ?>
                            ...
                            <button onclick="djBookNow('<?php echo $packageid ?>','<?php echo $_SESSION['user_email'] ?>','<?php echo $pacData['price'] ?>');" class="book-button">Book Now</button>
                    ...
                    <!-- <div class="blocker">
                        <h4>Your'e Not Signed in</h4>
                        <button class="blocker-button">sign in</button>
                    </div>
                    <h3 class="booking-area-tag">Booking Area</h3>
                    <span class="full-name">Full Name &nbsp; :<span></span><span></span></span>
                    <span class="E-mail">E-mail &nbsp; &nbsp; &nbsp; &nbsp; : </span>
                ...
                <div class="booked-days-container clk">
                    <h3 class="booked-days-table-tag pop">Booked Days</h3>
        ...
        <script src="js/dj-package-view.js"></script>
