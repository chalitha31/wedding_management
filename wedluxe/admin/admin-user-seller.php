...
?>
    ...
    <head>
        ...
        <title>User Seller Manage</title>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <span onclick="pageTravel('admin-user-seller.php')" class="sidebar-active styl1">User Seller</span>
        ...
        <div class="admin-container">
            ...
            <div class="page-title">User Seller Manage</div>
        ...
        <script src="admin-js/admin-profile-manage.js"></script>
        <script src="admin-js/user-seller.js"></script>
