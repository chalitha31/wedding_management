        ...
        <div class="dj-profile-container">
                    ...
                    ?>
                        ...
                        <div class="package dj-pack">
                            ...
                            <ul>
                                ...
                                $resultset = Database::search("SELECT * FROM `dj_package_features` WHERE `package_id` = '" . $pac["id"] . "'   ");
            ...
            <div class="review-page">
                ...
                <div class="box-container">
                    ...
                    $result = Database::search("SELECT * FROM `feedback` WHERE `booking_table_id` = '1' AND `bok_id` = '" . $djid . "'");
